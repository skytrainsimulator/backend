...
-- The GTFS schema is generated by https://github.com/public-transport/gtfs-via-postgres v4.10.1
...
WHERE "gtfs".stop_times.trip_id = t.trip_id
AND "gtfs".stop_times.stop_sequence = t.stop_sequence;
...
CREATE TABLE "gtfs".transfers (
	...
	FOREIGN KEY (from_route_id) REFERENCES "gtfs".routes,
	from_trip_id TEXT,
	FOREIGN KEY (from_trip_id) REFERENCES "gtfs".trips,
	to_trip_id TEXT,
	FOREIGN KEY (from_trip_id) REFERENCES "gtfs".trips
);
...
------------------------------------------------------------------------------------------------------------------------
-- END GTFS generated
CREATE FUNCTION gtfs.is_skytrain_route(route_id text) RETURNS BOOLEAN LANGUAGE sql IMMUTABLE AS $$
